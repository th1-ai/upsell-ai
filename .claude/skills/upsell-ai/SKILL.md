---
name: upsell-ai
description: Run Upsell AI ("The Merchant") — Runs the whole upsell journey around every booking.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Merchant", "/upsell-ai", "check the queue", "what is waiting for me", "approve that draft".
---

# Upsell AI

Runs Upsell AI and works its review queue. Everything happens from the repo
